...
from .node.clip_text_encode_node import NODE_CLASS_MAPPINGS as CLIP_TEXT_ENCODE_BLOCK_NODE_CLASS_MAPPINGS
from .node.clip_text_encode_node import NODE_DISPLAY_NAME_MAPPINGS as CLIP_TEXT_ENCODE_BLOCK_NODE_DISPLAY_NAME_MAPPINGS
from .node.string_block_node import NODE_CLASS_MAPPINGS as STRING_BLOCK_NODE_CLASS_MAPPINGS
from .node.string_block_node import NODE_DISPLAY_NAME_MAPPINGS as STRING_BLOCK_NODE_DISPLAY_NAME_MAPPINGS
from .node.join_strings_node import NODE_CLASS_MAPPINGS as JOIN_STRINGS_NODE_CLASS_MAPPINGS
from .node.join_strings_node import NODE_DISPLAY_NAME_MAPPINGS as JOIN_STRINGS_NODE_DISPLAY_NAME_MAPPINGS
...
NODE_CLASS_MAPPINGS = {
    ...
    **CLIP_TEXT_ENCODE_BLOCK_NODE_CLASS_MAPPINGS,
    **STRING_BLOCK_NODE_CLASS_MAPPINGS,
    **JOIN_STRINGS_NODE_CLASS_MAPPINGS,
}
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    **CLIP_TEXT_ENCODE_BLOCK_NODE_DISPLAY_NAME_MAPPINGS,
    **STRING_BLOCK_NODE_DISPLAY_NAME_MAPPINGS,
    **JOIN_STRINGS_NODE_DISPLAY_NAME_MAPPINGS,
}
WEB_DIRECTORY = "./js"
